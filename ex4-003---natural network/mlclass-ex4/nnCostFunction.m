...
J = -1/m * ( sum(sum(Y.*log(A3))) + sum(sum((1.-Y).*(log(1.-A3))))) + lambda/(2*m)*(sum(sum(Theta1(1:hidden_layer_size, 2:end).^2)) + sum(sum(Theta2(1:num_labels, 2:end).^2)))
